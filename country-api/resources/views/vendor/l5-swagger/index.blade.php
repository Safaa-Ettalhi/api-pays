...
<head>
    ...
    <title>API-Country Documentation - {{ $documentationTitle }}</title>
...
<div class="topbar">
    <h1>API-Country Documentation</h1>
    <p>Explore and test country-related API endpoints</p>
</div>
<div id="swagger-ui"></div>

<div class="footer">
    &copy; {{ date('Y') }} API-Country - Documentation générée avec Swagger
</div>
